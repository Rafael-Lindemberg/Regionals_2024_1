...
public class Robot extends TimedRobot {
  ...
  public void testInit() {
    ...
    //   () -> RobotContainer.getController().getPOV() == 0,
    //   () -> RobotContainer.getController().getPOV() == 180,
    //   () -> RobotContainer.getController().getPOV() == 270,
    //   () -> RobotContainer.getController().getPOV() == 90
    // ));
    //RobotContainer.getCompressor().disable();
  }
  ...
  public void testExit() {
    ...
    //RobotContainer.getCompressor().enableDigital();
  }
